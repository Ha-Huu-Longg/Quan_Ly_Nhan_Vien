...
function PromotedModal({ open, onCancel, employeeInfo, promoteRecord, onSend }) {
    return (
        <Modal
        ...
        >
            <Form className="use-font-time">
                ...
                <div className="modal_content">
                    ...
                    <div className="modal_content-body">
                        <Form.Item name="dateSalary" label="Điều 1: kể từ ngày ">
                            <Input defaultValue={formatDate(promoteRecord.date)} />
                        </Form.Item>
                        <Form.Item name="fullName" label="Điều chỉnh chức của Ông/Bà ">
                            <Input defaultValue={employeeInfo.fullName} />
                        </Form.Item>
                        <Form.Item name="rank" label="sẽ là chức ">
                            <Input defaultValue={promoteRecord.newPosition} />
                        </Form.Item>
                    </div>
                ...
                <div className="modal_signature">
                    ...
                    <p>TỔNG GIÁM ĐỐC</p>
                    <p className="font-z-13 font-s-i">Tech</p>
                    <p>OceanTech</p>
                </div>
            </Form>
        </Modal>
